...
class ChoresControllerTest < ActionController::TestCase
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post :create, chore: { description: @chore.description, image_url: @chore.image_url, title: @chore.title }
    end
  ...
  test "should update chore" do
    patch :update, id: @chore, chore: { description: @chore.description, image_url: @chore.image_url, title: @chore.title }
    assert_redirected_to chore_path(assigns(:chore))
  end
